...
//
// Code generated for Simulink model 'TP_3tanks_sim'.
//
// Model version                  : 1.19
// Simulink Coder version         : 24.2 (R2024b) 21-Jun-2024
// C/C++ source code generated on : Fri Mar 29 11:19:07 2024
//
#ifdef _MSC_VER
#pragma warning(push)
...
const std::string SLROSNodeName("TP_3tanks_sim");
...
void NodeInterface::initialize(int argc, char * const argv[]) {
    try {
		...
		mSchedulerTimer = SLROSNodePtr->create_wall_timer(std::chrono::nanoseconds(2000000000),std::bind(&NodeInterface::schedulerThreadCallback,this),mSchedulerGroup);
    }
