...
MAKECMD         = /usr/local/MATLAB/R2024b/bin/glnxa64/gmake -j 2 -l 2
HOST            = UNIX
BUILD           = yes
SYS_TARGET_FILE = any
...
MODEL                   = TP_3tanks_sim
MODULES                 = TP_3tanks_sim.c TP_3tanks_sim_capi.c TP_3tanks_sim_data.c TP_3tanks_sim_tgtconn.c rtGetInf.c rt_nonfinite.c raccel_main.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c slsa_sim_common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT                 = TP_3tanks_sim
MAKEFILE                = TP_3tanks_sim.mk
MATLAB_ROOT             = /usr/local/MATLAB/R2024b
ALT_MATLAB_ROOT         = /usr/local/MATLAB/R2024b
START_DIR               = /home/thomas/TPs_systems_control
S_FUNCTIONS_LIB         = 
NUMST                   = 2
NCSTATES                = 7
COMPUTER                = GLNXA64
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/raccel/TP_3tanks_sim \
